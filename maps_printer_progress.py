...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'maps_printer_progressdialog.ui'))


class MapsPrinterProgress(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(MapsPrinterProgress, self).__init__(parent)
